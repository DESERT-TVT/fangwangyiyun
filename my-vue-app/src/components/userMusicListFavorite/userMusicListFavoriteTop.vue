                    ...
                    <div class="addMusicListArea">
                        <el-form :model="form" size="large" :rules="rules" status-icon ref="formRef">
                            <el-form-item prop="name">
                                <input type="text" name="name" class="name" placeholder="请输入歌单名称" v-model="form.name">
                            </el-form-item>
                        </el-form>
                    </div>
                    <div class="btnArea">
        ...
        <div class="infosContent" id="infosContent">
            <div class="infos">
                <div class="infosPic">
                    ...
                    <el-image class="img" :src="playlist.coverImgUrl" :preview-src-list="[playlist.coverImgUrl]"
                        fit="cover"></el-image>
                </div>
                <div class="infosText">
